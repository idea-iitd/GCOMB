...
flags.DEFINE_integer('dim_1', 40, 'Size of output dim (final is 2x this, if using concat)')
flags.DEFINE_integer('dim_2', 40, 'Size of output dim (final is 2x this, if using concat)')
