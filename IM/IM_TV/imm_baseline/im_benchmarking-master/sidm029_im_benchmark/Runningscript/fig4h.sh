...
mkdir -p ../Results/freshRuns/processed/fig4h
python ../Codes/convergenceCheck.py imm ../Results/freshRuns/algorithmOutput/fig4h/imm/flowstat_0.05_300 ../Results/freshRuns/algorithmOutput/fig4h/imm/flowstat_ ../Results/freshRuns/processed/fig4h/imm.txt
...
python ../Codes/convergenceCheck.py tim ../Results/freshRuns/algorithmOutput/fig4h/tim/flowstat_0.05_300 ../Results/freshRuns/algorithmOutput/fig4h/tim/flowstat_ ../Results/freshRuns/processed/fig4h/tim.txt
cp ../Results/Alreadypresent/fig4h/plotnew.p ../Results/freshRuns/processed/fig4h/
cd ../Results/freshRuns/processed/fig4h/
gnuplot plotnew.p
epspdf output.eps
