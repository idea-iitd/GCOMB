...
outputcelf="../Results/freshRuns/algorithmOutput/fig6j-7j-8j/celf"
outputcelfpp="../Results/freshRuns/algorithmOutput/fig6j-7j-8j/celfpp"
outputeasyim="../Results/freshRuns/algorithmOutput/fig6j-7j-8j/easyim"
outputimm="../Results/freshRuns/algorithmOutput/fig6j-7j-8j/imm"
outputtim="../Results/freshRuns/algorithmOutput/fig6j-7j-8j/tim"
outputpmc="../Results/freshRuns/algorithmOutput/fig6j-7j-8j/pmc"
outputimrank="../Results/freshRuns/algorithmOutput/fig6j-7j-8j/imrank"
outputsg="../Results/freshRuns/algorithmOutput/fig6j-7j-8j/sg"
outputirie="../Results/freshRuns/algorithmOutput/fig6j-7j-8j/irie"
outputsimpath="../Results/freshRuns/algorithmOutput/fig6j-7j-8j/simpath"
outputldag="../Results/freshRuns/algorithmOutput/fig6j-7j-8j/ldag"

mkdir -p ../Results/freshRuns/algorithmOutput/fig6j-7j-8j
mkdir -p ../Results/freshRuns/processed/fig6j-7j-8j
mkdir -p $outputcelf
...
do
	...
	cat $outputimm"/stat_IMM_"$model"_"$seeds"_"$imm_eps".txt"  >> ../Results/freshRuns/processed/fig6j-7j-8j/immtime.txt
...
cp $outputimm"/flowstat_"$imm_eps"_300" ../Results/freshRuns/processed/fig6j-7j-8j/imm.txt
...
do
	...
	cat $outputtim"/stat_TIM_"$model"_"$seeds"_"$tim_eps".txt" >> ../Results/freshRuns/processed/fig6j-7j-8j/timtime.txt
...
cp $outputtim"/flowstat_"$tim_eps"_300" ../Results/freshRuns/processed/fig6j-7j-8j/tim.txt
...
do
	...
	cat $outputeasyim"/stat_seeds="$seeds"_iter="$easyim_iter"_depth=3.txt" >> ../Results/freshRuns/processed/fig6j-7j-8j/easyimtime.txt
...
cp $outputeasyim"/flowstat_"$easyim_iter".txt_300" ../Results/freshRuns/processed/fig6j-7j-8j/easyim.txt


echo "Running SIMPATH" 
echo $execfilesimpath" -propModel "$simpathmodel" -mcruns "$simpath_mc" -budget 200 -celfPlus 1 -phase "$simpath_phase" -cutoff 0.001 -topl 4 -probGraphFile "$pathtograph" -outdir "$outputsimpath
$execfilesimpath -propModel $simpathmodel -mcruns $simpath_mc -budget 200 -celfPlus 1 -phase $simpath_phase -cutoff 0.001 -topl 4 -probGraphFile $pathtograph -outdir $outputsimpath
cp $outputsimpath"/stats_LTNew_"$simpath_mc".txt" ../Results/freshRuns/processed/fig6j-7j-8j/simpathtime.txt

echo $execFlow $pathtograph $outputsimpath"/seeds_LTNew_"$simpath_mc".txt" 200 1 $flowiter 3 $outputsimpath"/flowstat_"$simpath_mc".txt" $outputsimpath"/spread.txt"
$execFlow $pathtograph $outputsimpath"/seeds_LTNew_"$simpath_mc".txt" 200 1 $flowiter 3 $outputsimpath"/flowstat_"$simpath_mc".txt" $outputsimpath"/spread.txt"
cp $outputsimpath"/flowstat_"$simpath_mc".txt_300" ../Results/freshRuns/processed/fig6j-7j-8j/simpath.txt

echo "Running LDAG" 
echo $execfileldag" -propModel "$ldagmodel" -mcruns "$ldag_mc" -budget 200 -phase "$ldag_phase" -tol_ldag 0.003125 -probGraphFile "$pathtograph" -outdir "$outputldag
$execfileldag -propModel $ldagmodel -mcruns $ldag_mc -budget 200 -phase $ldag_phase -tol_ldag 0.003125 -probGraphFile $pathtograph -outdir $outputldag
cp $outputldag"/stats_LT.txt" ../Results/freshRuns/processed/fig6j-7j-8j/ldagtime.txt

echo $execFlow $pathtograph $outputldag"/seeds_LT.txt" 200 1 $flowiter 3 $outputldag"/flowstat_"$ldag_mc".txt" $outputldag"/spread.txt"
$execFlow $pathtograph $outputldag"/seeds_LT.txt" 200 1 $flowiter 3 $outputldag"/flowstat_"$ldag_mc".txt" $outputldag"/spread.txt"
cp $outputldag"/flowstat_"$ldag_mc".txt_300" ../Results/freshRuns/processed/fig6j-7j-8j/ldag.txt

paste ../Results/Alreadypresent/fig6abcd/seedfile ../Results/freshRuns/processed/fig6j-7j-8j/easyimtime.txt > tmp
mv tmp ../Results/freshRuns/processed/fig6j-7j-8j/easyimtime.txt

paste ../Results/Alreadypresent/fig6abcd/seedfile ../Results/freshRuns/processed/fig6j-7j-8j/immtime.txt > tmp
mv tmp ../Results/freshRuns/processed/fig6j-7j-8j/immtime.txt

paste ../Results/Alreadypresent/fig6abcd/seedfile ../Results/freshRuns/processed/fig6j-7j-8j/timtime.txt > tmp
mv tmp ../Results/freshRuns/processed/fig6j-7j-8j/timtime.txt


cp ../Results/Alreadypresent/fig6ijkl/plotnew.p ../Results/freshRuns/processed/fig6j-7j-8j/
cp ../Results/Alreadypresent/fig6ijkl/plotnewtime.p ../Results/freshRuns/processed/fig6j-7j-8j/
cp ../Results/Alreadypresent/fig6ijkl/plotnewmem.p ../Results/freshRuns/processed/fig6j-7j-8j/
cd ../Results/freshRuns/processed/fig6j-7j-8j/
gnuplot plotnew.p
