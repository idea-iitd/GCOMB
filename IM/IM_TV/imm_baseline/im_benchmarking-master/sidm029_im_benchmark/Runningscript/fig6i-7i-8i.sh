...
cp $outputcelf"/stats_SIMPATH_LT_"$simpath_mc".txt" ../Results/freshRuns/processed/fig6i-7i-8i/simpathtime.txt
...
cp $outputcelf"/flowstat_"$simpath_mc".txt_300" ../Results/freshRuns/processed/fig6i-7i-8i/simpath.txt
...
cp $outputcelf"/stats_LDAG_LT_"$ldag_mc".txt" ../Results/freshRuns/processed/fig6i-7i-8i/ldagtime.txt
...
cp $outputcelf"/flowstat_"$ldag_mc".txt_300" ../Results/freshRuns/processed/fig6i-7i-8i/ldag.txt
...
cp $outputcelf"/stats_CELF_LT_"$celf_mc".txt" ../Results/freshRuns/processed/fig6i-7i-8i/celftime.txt
...
cp $outputcelf"/flowstat_"$celf_mc".txt_300" ../Results/freshRuns/processed/fig6i-7i-8i/celf.txt
...
cp $outputcelfpp"/stats_CELF++_LT_"$celfpp_mc".txt" ../Results/freshRuns/processed/fig6i-7i-8i/celfpptime.txt
...
cp $outputcelfpp"/flowstat_"$celfpp_mc".txt_300" ../Results/freshRuns/processed/fig6i-7i-8i/celfpp.txt
