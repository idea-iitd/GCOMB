...
do
	...
	cat $outputeasyim"/stat_seeds="$seeds"_iter="$easyim_iter"_depth=3.txt" >> ../Results/freshRuns/processed/fig6d-7d-8d/easyimtime.txt
...
cp $outputeasyim"/flowstat_"$easyim_iter".txt_300" ../Results/freshRuns/processed/fig6d-7d-8d/easyim.txt
...
cp $outputcelf"/stats_CELF_IC_"$celf_mc".txt" ../Results/freshRuns/processed/fig6d-7d-8d/celftime.txt
...
cp $outputcelf"/flowstat_"$celf_mc".txt_300" ../Results/freshRuns/processed/fig6d-7d-8d/celf.txt
...
cp $outputcelfpp"/stats_CELF++_IC_"$celfpp_mc".txt" ../Results/freshRuns/processed/fig6d-7d-8d/celfpptime.txt
...
cp $outputcelfpp"/flowstat_"$celfpp_mc".txt_300" ../Results/freshRuns/processed/fig6d-7d-8d/celfpp.txt
