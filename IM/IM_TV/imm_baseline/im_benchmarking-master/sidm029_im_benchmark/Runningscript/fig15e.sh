...
model="IC"
outputeasyim="../Results/freshRuns/algorithmOutput/fig15e/easyim"
mkdir -p ../Results/freshRuns/algorithmOutput/fig15e
...
mkdir -p ../Results/freshRuns/processed/fig15e

python ../Codes/convergenceCheck.py easyim $outputeasyim"/flowstat_1000.txt_300" $outputcelf"/flowstat_"  ../Results/freshRuns/processed/fig15e/easyim.txt
