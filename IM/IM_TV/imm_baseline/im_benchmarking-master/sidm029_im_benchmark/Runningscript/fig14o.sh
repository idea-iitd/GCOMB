...
model="IC"
outputsg="../../Results/freshRuns/algorithmOutput/fig14o/sg"
outputsgcr="../Results/freshRuns/algorithmOutput/fig14o/sg"
mkdir -p ../Results/freshRuns/algorithmOutput/fig14o
mkdir -p $outputsgcr
numiter=10000
