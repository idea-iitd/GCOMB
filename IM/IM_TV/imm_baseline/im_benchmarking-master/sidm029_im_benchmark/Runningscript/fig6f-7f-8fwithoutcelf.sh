...
outputcelf="../Results/freshRuns/algorithmOutput/fig6f-7f-8f/celf"
outputcelfpp="../Results/freshRuns/algorithmOutput/fig6f-7f-8f/celfpp"
outputeasyim="../Results/freshRuns/algorithmOutput/fig6f-7f-8f/easyim"
outputimm="../Results/freshRuns/algorithmOutput/fig6f-7f-8f/imm"
outputtim="../Results/freshRuns/algorithmOutput/fig6f-7f-8f/tim"
outputpmc="../Results/freshRuns/algorithmOutput/fig6f-7f-8f/pmc"
outputimrank="../Results/freshRuns/algorithmOutput/fig6f-7f-8f/imrank"
outputsg="../Results/freshRuns/algorithmOutput/fig6f-7f-8f/sg"
outputirie="../Results/freshRuns/algorithmOutput/fig6f-7f-8f/irie"
#outputsimpath="../Results/freshRuns/algorithmOutput/fig6f-7f-8f/simpath"
#outputldag="../Results/freshRuns/algorithmOutput/fig6f-7f-8f/ldag"
mkdir -p ../Results/freshRuns/processed/fig6f-7f-8f
mkdir -p ../Results/freshRuns/algorithmOutput/fig6f-7f-8f
mkdir -p $outputcelf
...
do
	...
	do
		...
		cat $outputimrank"/statIMRank_k"$seeds"_l"$l"_LOOP10_irDegree.txt" >> ../Results/freshRuns/processed/fig6f-7f-8f/imrank$l"time.txt"
	...
	cp $outputimrank"/flowstat_l="$l"_rounds="$imrank_rounds".txt_300" ../Results/freshRuns/processed/fig6f-7f-8f/imrank$l".txt"
done
cd ../Runningscript
...
do
	...
	cat $outputirie"/statFileseeds-"$seeds".txt" >> ../Results/freshRuns/processed/fig6f-7f-8f/irietime.txt
...
cp $outputirie"/flowstat_alpha=0.7_300" ../Results/freshRuns/processed/fig6f-7f-8f/irie.txt
cd ../Runningscript
...
cp $outputpmc"/stats_PMC_IC_"$pmc_r".txt" ../Results/freshRuns/processed/fig6f-7f-8f/pmctime.txt
...
cp $outputpmc"/flowstat_"$pmc_r".txt_300" ../Results/freshRuns/processed/fig6f-7f-8f/pmc.txt
...
do
	...
	cat $outputsg"/statStaticGreedyUD_SGD_R"$sg_r"_k"$seeds".txt" >> ../Results/freshRuns/processed/fig6f-7f-8f/sgtime.txt
...
cp $outputsg"/flowstat_snapshots="$sg_r"_300"  ../Results/freshRuns/processed/fig6f-7f-8f/sg.txt
...
do
	...
	cat $outputimm"/stat_IMM_"$model"_"$seeds"_"$imm_eps".txt"  >> ../Results/freshRuns/processed/fig6f-7f-8f/immtime.txt
...
cp $outputimm"/flowstat_"$imm_eps"_300" ../Results/freshRuns/processed/fig6f-7f-8f/imm.txt
echo "Running TIM+"
for seeds in 1 2 5 10 25 50 75 100 125 150 175 200
do
	...
	cat $outputtim"/stat_TIM_"$model"_"$seeds"_"$tim_eps".txt" >> ../Results/freshRuns/processed/fig6f-7f-8f/timtime.txt
...
cp $outputtim"/flowstat_"$tim_eps"_300" ../Results/freshRuns/processed/fig6f-7f-8f/tim.txt
...
do
	...
	$execfileeasyim $pathtograph 2 $seeds 1 $easyim_iter 3 $outputeasyim
        cat $outputeasyim"/stat_seeds="$seeds"_iter="$easyim_iter"_depth=3.txt" >> ../Results/freshRuns/processed/fig6f-7f-8f/easyimtime.txt
...
cp $outputeasyim"/flowstat_"$easyim_iter".txt_300" ../Results/freshRuns/processed/fig6f-7f-8f/easyim.txt

paste ../Results/Alreadypresent/fig6abcd/seedfile ../Results/freshRuns/processed/fig6f-7f-8f/easyimtime.txt > tmp
mv tmp ../Results/freshRuns/processed/fig6f-7f-8f/easyimtime.txt

paste ../Results/Alreadypresent/fig6abcd/seedfile ../Results/freshRuns/processed/fig6f-7f-8f/immtime.txt > tmp
mv tmp ../Results/freshRuns/processed/fig6f-7f-8f/immtime.txt

paste ../Results/Alreadypresent/fig6abcd/seedfile ../Results/freshRuns/processed/fig6f-7f-8f/timtime.txt > tmp
mv tmp ../Results/freshRuns/processed/fig6f-7f-8f/timtime.txt

paste ../Results/Alreadypresent/fig6abcd/seedfile ../Results/freshRuns/processed/fig6f-7f-8f/imrank1time.txt > tmp
mv tmp ../Results/freshRuns/processed/fig6f-7f-8f/imrank1time.txt

paste ../Results/Alreadypresent/fig6abcd/seedfile ../Results/freshRuns/processed/fig6f-7f-8f/imrank2time.txt > tmp
mv tmp ../Results/freshRuns/processed/fig6f-7f-8f/imrank2time.txt

cp ../Results/Alreadypresent/fig6abcd/plotnew.p ../Results/freshRuns/processed/fig6f-7f-8f/
cp ../Results/Alreadypresent/fig6abcd/plotnewtime.p ../Results/freshRuns/processed/fig6f-7f-8f/
cp ../Results/Alreadypresent/fig6abcd/plotnewmem.p ../Results/freshRuns/processed/fig6f-7f-8f/
cd ../Results/freshRuns/processed/fig6f-7f-8f/
gnuplot plotnew.p
