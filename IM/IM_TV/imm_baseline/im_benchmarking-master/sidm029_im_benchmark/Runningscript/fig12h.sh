...
model="IC"
outputimm="../Results/freshRuns/algorithmOutput/fig12h/imm"
mkdir -p ../Results/freshRuns/algorithmOutput/fig12h
mkdir -p $outputimm
...
mkdir -p ../Results/freshRuns/processed/fig12h
python ../Codes/process12.py $outputimm"/flowstat_"$eps"_" ../Results/freshRuns/processed/fig12h/imm.txt
