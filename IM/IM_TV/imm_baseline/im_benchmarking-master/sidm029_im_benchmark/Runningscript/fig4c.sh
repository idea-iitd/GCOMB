...
python ../Codes/convergenceCheck.py celf $outputcelf"/flowst_10000.txt_300" $outputcelf"/flowst_"  ../Results/freshRuns/processed/fig4c/celf.txt

python ../Codes/convergenceCheck.py celf $outputcelfpp"/flowst_10000.txt_300" $outputcelfpp"/flowst_"  ../Results/freshRuns/processed/fig4c/celfpp.txt
