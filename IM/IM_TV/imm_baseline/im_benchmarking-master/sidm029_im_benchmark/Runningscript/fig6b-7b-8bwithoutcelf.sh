...
outputcelf="../Results/freshRuns/algorithmOutput/fig6b-7b-8b/celf"
outputcelfpp="../Results/freshRuns/algorithmOutput/fig6b-7b-8b/celfpp"
outputeasyim="../Results/freshRuns/algorithmOutput/fig6b-7b-8b/easyim"
outputimm="../Results/freshRuns/algorithmOutput/fig6b-7b-8b/imm"
outputtim="../Results/freshRuns/algorithmOutput/fig6b-7b-8b/tim"
outputpmc="../Results/freshRuns/algorithmOutput/fig6b-7b-8b/pmc"
outputimrank="../Results/freshRuns/algorithmOutput/fig6b-7b-8b/imrank"
outputsg="../Results/freshRuns/algorithmOutput/fig6b-7b-8b/sg"
outputirie="../Results/freshRuns/algorithmOutput/fig6b-7b-8b/irie"
#outputsimpath="../Results/freshRuns/algorithmOutput/fig6b-7b-8b/simpath"
#outputldag="../Results/freshRuns/algorithmOutput/fig6b-7b-8b/ldag"

mkdir -p ../Results/freshRuns/processed/fig6b-7b-8b
mkdir -p ../Results/freshRuns/algorithmOutput/fig6b-7b-8b
mkdir -p $outputcelf
...
do
	...
	do
		...
		cd ../Codes/imrank
		g++  -g -std=c++11  -g -o mymain limit.h general_cascade.cpp graph.cpp random.cpp degree.cpp greedy.cpp degreediscount_ic.cpp weightedegree.cpp SPM_gc.cpp SP1M_gc.cpp pmia.cpp pagerank.cpp mia.cpp IMRank.cpp main.cpp -w "-DIMRank_LOOP="$imrank_rounds "-DSET_SIZE="$seeds -DMAX_NODE=11204 -DMAX_EDGE=235238
		...
		cat $outputimrank"/statIMRank_k"$seeds"_l"$l"_LOOP10_irDegree.txt" >> ../Results/freshRuns/processed/fig6b-7b-8b/imrank$l"time.txt"
	...
	cp $outputimrank"/flowstat_l="$l"_rounds="$imrank_rounds".txt_300" ../Results/freshRuns/processed/fig6b-7b-8b/imrank$l".txt"
done
cd ../Runningscript
...
do
	...
	cat $outputirie"/statFileseeds-"$seeds".txt" >> ../Results/freshRuns/processed/fig6b-7b-8b/irietime.txt
...
cp $outputirie"/flowstat_alpha=0.7_300" ../Results/freshRuns/processed/fig6b-7b-8b/irie.txt
cd ../Runningscript
...
cp $outputpmc"/stats_PMC_IC_"$pmc_r".txt" ../Results/freshRuns/processed/fig6b-7b-8b/pmctime.txt
...
cp $outputpmc"/flowstat_"$pmc_r".txt_300" ../Results/freshRuns/processed/fig6b-7b-8b/pmc.txt
...
do
	...
	cat $outputsg"/statStaticGreedyUD_SGD_R"$sg_r"_k"$seeds".txt" >> ../Results/freshRuns/processed/fig6b-7b-8b/sgtime.txt
...
cp $outputsg"/flowstat_snapshots="$sg_r"_300"  ../Results/freshRuns/processed/fig6b-7b-8b/sg.txt
...
do
	...
	cat $outputimm"/stat_IMM_"$model"_"$seeds"_"$imm_eps".txt"  >> ../Results/freshRuns/processed/fig6b-7b-8b/immtime.txt
...
cp $outputimm"/flowstat_"$imm_eps"_300" ../Results/freshRuns/processed/fig6b-7b-8b/imm.txt
...
do
	...
	cat $outputtim"/stat_TIM_"$model"_"$seeds"_"$tim_eps".txt" >> ../Results/freshRuns/processed/fig6b-7b-8b/timtime.txt
...
cp $outputtim"/flowstat_"$tim_eps"_300" ../Results/freshRuns/processed/fig6b-7b-8b/tim.txt
...
do
	...
	cat $outputeasyim"/stat_seeds="$seeds"_iter="$easyim_iter"_depth=3.txt" >> ../Results/freshRuns/processed/fig6b-7b-8b/easyimtime.txt
...
cp $outputeasyim"/flowstat_"$easyim_iter".txt_300" ../Results/freshRuns/processed/fig6b-7b-8b/easyim.txt

paste ../Results/Alreadypresent/fig6abcd/seedfile ../Results/freshRuns/processed/fig6b-7b-8b/easyimtime.txt > tmp
mv tmp ../Results/freshRuns/processed/fig6b-7b-8b/easyimtime.txt

paste ../Results/Alreadypresent/fig6abcd/seedfile ../Results/freshRuns/processed/fig6b-7b-8b/immtime.txt > tmp
mv tmp ../Results/freshRuns/processed/fig6b-7b-8b/immtime.txt

paste ../Results/Alreadypresent/fig6abcd/seedfile ../Results/freshRuns/processed/fig6b-7b-8b/timtime.txt > tmp
mv tmp ../Results/freshRuns/processed/fig6b-7b-8b/timtime.txt

paste ../Results/Alreadypresent/fig6abcd/seedfile ../Results/freshRuns/processed/fig6b-7b-8b/imrank1time.txt > tmp
mv tmp ../Results/freshRuns/processed/fig6b-7b-8b/imrank1time.txt

paste ../Results/Alreadypresent/fig6abcd/seedfile ../Results/freshRuns/processed/fig6b-7b-8b/imrank2time.txt > tmp
mv tmp ../Results/freshRuns/processed/fig6b-7b-8b/imrank2time.txt

cp ../Results/Alreadypresent/fig6abcd/plotnew.p ../Results/freshRuns/processed/fig6b-7b-8b/
cp ../Results/Alreadypresent/fig6abcd/plotnewtime.p ../Results/freshRuns/processed/fig6b-7b-8b/
cp ../Results/Alreadypresent/fig6abcd/plotnewmem.p ../Results/freshRuns/processed/fig6b-7b-8b/
cd ../Results/freshRuns/processed/fig6b-7b-8b/
gnuplot plotnew.p
