...
model="IC"
outputimm="../Results/freshRuns/algorithmOutput/fig12d/imm"
mkdir -p ../Results/freshRuns/algorithmOutput/fig12d
mkdir -p $outputimm
...
mkdir -p ../Results/freshRuns/processed/fig12d
python ../Codes/process12.py $outputimm"/flowstat_"$eps"_" ../Results/freshRuns/processed/fig12d/imm.txt
cp ../Results/Alreadypresent/fig12d/plotnew.p ../Results/freshRuns/processed/fig12d/
cd ../Results/freshRuns/processed/fig12d/
gnuplot plotnew.p
epspdf output.eps
