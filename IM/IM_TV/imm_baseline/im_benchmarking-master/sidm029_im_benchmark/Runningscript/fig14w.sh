...
model="WC"
outputimrank="../../Results/freshRuns/algorithmOutput/fig14w/imrank"
outputimrankcr="../Results/freshRuns/algorithmOutput/fig14w/imrank"
mkdir -p ../Results/freshRuns/algorithmOutput/fig14w
