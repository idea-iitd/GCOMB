...
model="IC"
outputimrank="../../Results/freshRuns/algorithmOutput/fig5b/imrank"
outputimrankcr="../Results/freshRuns/algorithmOutput/fig5b/imrank"
mkdir -p ../Results/freshRuns/algorithmOutput/fig5b
