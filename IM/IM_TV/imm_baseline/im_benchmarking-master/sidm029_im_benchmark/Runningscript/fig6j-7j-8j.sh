...
cp $outputcelf"/stats_SIMPATH_LT_"$simpath_mc".txt" ../Results/freshRuns/processed/fig6j-7j-8j/simpathtime.txt
...
cp $outputcelf"/flowstat_"$simpath_mc".txt_300" ../Results/freshRuns/processed/fig6j-7j-8j/simpath.txt
...
cp $outputcelf"/stats_LDAG_LT_"$ldag_mc".txt" ../Results/freshRuns/processed/fig6j-7j-8j/ldagtime.txt
...
cp $outputcelf"/flowstat_"$ldag_mc".txt_300" ../Results/freshRuns/processed/fig6j-7j-8j/ldag.txt
...
cp $outputcelf"/stats_CELF_LT_"$celf_mc".txt" ../Results/freshRuns/processed/fig6j-7j-8j/celftime.txt
...
cp $outputcelf"/flowstat_"$celf_mc".txt_300" ../Results/freshRuns/processed/fig6j-7j-8j/celf.txt
...
cp $outputcelfpp"/stats_CELF++_LT_"$celfpp_mc".txt" ../Results/freshRuns/processed/fig6j-7j-8j/celfpptime.txt
...
cp $outputcelfpp"/flowstat_"$celfpp_mc".txt_300" ../Results/freshRuns/processed/fig6j-7j-8j/celfpp.txt
