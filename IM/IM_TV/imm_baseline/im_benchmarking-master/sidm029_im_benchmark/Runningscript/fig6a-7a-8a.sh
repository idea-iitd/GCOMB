...
cp $outputcelf"/stats_CELF_IC_"$celf_mc".txt" ../Results/freshRuns/processed/fig6a-7a-8a/celftime.txt
...
cp $outputcelf"/flowstat_"$celf_mc".txt_300" ../Results/freshRuns/processed/fig6a-7a-8a/celf.txt
...
cp $outputcelfpp"/stats_CELF++_IC_"$celfpp_mc".txt" ../Results/freshRuns/processed/fig6a-7a-8a/celfpptime.txt
...
cp $outputcelfpp"/flowstat_"$celfpp_mc".txt_300" ../Results/freshRuns/processed/fig6a-7a-8a/celfpp.txt
