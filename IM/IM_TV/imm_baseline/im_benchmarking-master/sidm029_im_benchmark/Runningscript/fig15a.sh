...
model="IC"
outputcelf="../Results/freshRuns/algorithmOutput/fig15a/celf"
outputcelfpp="../Results/freshRuns/algorithmOutput/fig15a/celfpp"
outputeasyim="../Results/freshRuns/algorithmOutput/fig15a/easyim"
mkdir -p ../Results/freshRuns/algorithmOutput/fig15a
mkdir -p $outputcelf
...
mkdir -p ../Results/freshRuns/processed/fig15a
python ../Codes/convergenceCheck.py celf $outputcelf"/flowst_10000.txt_300" $outputcelf"/flowst_"  ../Results/freshRuns/processed/fig15a/celf.txt

python ../Codes/convergenceCheck.py celf $outputcelfpp"/flowst_10000.txt_300" $outputcelfpp"/flowst_"  ../Results/freshRuns/processed/fig15a/celfpp.txt

python ../Codes/convergenceCheck.py easyim $outputeasyim"/flowstat_1000.txt_300" $outputcelf"/flowstat_"  ../Results/freshRuns/processed/fig15a/easyim.txt
