...
model="IC"
outputtim="../Results/freshRuns/algorithmOutput/fig14g/tim"
mkdir -p ../Results/freshRuns/algorithmOutput/fig14g
mkdir -p $outputtim
...
python ../Codes/process5.py imm $outputimm"/flowstat_" ../Results/freshRuns/processed/fig14g/output.txt
