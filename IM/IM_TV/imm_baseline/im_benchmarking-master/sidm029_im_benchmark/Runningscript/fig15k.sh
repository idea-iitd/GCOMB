...
edge=62752
node=15229
outputimrank="../../Results/freshRuns/algorithmOutput/fig15k/imrank"
outputimrankcr="../Results/freshRuns/algorithmOutput/fig15k/imrank"
mkdir -p ../Results/freshRuns/algorithmOutput/fig15k
...
cd ../Runningscript
mkdir -p ../Results/freshRuns/processed/fig15k
for l in 1 2
do
        python ../Codes/convergenceCheck.py imrank "../Results/freshRuns/algorithmOutput/fig15k/imrank/flowst_l="$l"_rounds=10.txt_300" "../Results/freshRuns/algorithmOutput/fig15k/imrank/flowst_l="$l"_rounds="  ../Results/freshRuns/processed/fig15k/$l".txt"
done
