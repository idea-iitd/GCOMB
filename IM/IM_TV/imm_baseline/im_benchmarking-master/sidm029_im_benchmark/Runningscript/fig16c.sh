...
model="IC"
outputpmc="../Results/freshRuns/algorithmOutput/fig16c/pmc"
outputsg="../../Results/freshRuns/algorithmOutput/fig16c/sg"
outputsgcr="../Results/freshRuns/algorithmOutput/fig16c/sg"
mkdir -p ../Results/freshRuns/algorithmOutput/fig16c
mkdir -p $outputpmc
mkdir -p $outputsgcr
numiter=10000
...
mkdir -p ../Results/freshRuns/processed/fig16c
python ../Codes/convergenceCheck.py pmc "../Results/freshRuns/algorithmOutput/fig16c/pmc/flowst_300.txt_300" "../Results/freshRuns/algorithmOutput/fig16c/pmc/flowst_"  ../Results/freshRuns/processed/fig16c/pmc.txt
pathtograph="../../Dataset/dblp/graph_ic.inf"
...
python ../Codes/convergenceCheck.py static $outputsgcreate"/flowst_snapshots=300_300" "../Results/freshRuns/algorithmOutput/fig16c/sg/flowst_snapshots="  ../Results/freshRuns/processed/fig16c/sg.txt
