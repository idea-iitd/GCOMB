...
model="LT"
outputimm="../Results/freshRuns/algorithmOutput/fig16k/imm"
outputtim="../Results/freshRuns/algorithmOutput/fig16k/tim"
mkdir -p ../Results/freshRuns/algorithmOutput/fig16k
mkdir -p $outputimm
mkdir -p $outputtim
...
mkdir -p ../Results/freshRuns/processed/fig16k
python ../Codes/convergenceCheck.py imm ../Results/freshRuns/algorithmOutput/fig16k/imm/flowstat_0.05_300 ../Results/freshRuns/algorithmOutput/fig16k/imm/flowstat_ ../Results/freshRuns/processed/fig16k/imm.txt
echo "Running TIM+"
...
python ../Codes/convergenceCheck.py tim ../Results/freshRuns/algorithmOutput/fig16k/tim/flowstat_0.05_300 ../Results/freshRuns/algorithmOutput/fig16k/tim/flowstat_ ../Results/freshRuns/processed/fig16k/tim.txt
