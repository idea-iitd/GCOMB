...
model="LT"
outputimm="../Results/freshRuns/algorithmOutput/fig12c/imm"
mkdir -p ../Results/freshRuns/algorithmOutput/fig12c
mkdir -p $outputimm
...
mkdir -p ../Results/freshRuns/processed/fig12c
python ../Codes/process12.py $outputimm"/flowstat_"$eps"_" ../Results/freshRuns/processed/fig12c/imm.txt
cp ../Results/Alreadypresent/fig12c/plotnew.p ../Results/freshRuns/processed/fig12c/
cd ../Results/freshRuns/processed/fig12c/
gnuplot plotnew.p
epspdf output.eps
