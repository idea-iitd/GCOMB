...
model="IC"
outputcelfpp="../Results/freshRuns/algorithmOutput/fig14d/celfpp"
mkdir -p ../Results/freshRuns/algorithmOutput/fig14d
...
mkdir -p ../Results/freshRuns/processed/fig14d
python ../Codes/process5.py celf $outputcelf"/flowst_" ../Results/freshRuns/processed/fig14d/output.txt
