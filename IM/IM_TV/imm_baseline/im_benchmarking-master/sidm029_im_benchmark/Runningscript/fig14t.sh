...
model="IC"
outputimrank="../../Results/freshRuns/algorithmOutput/fig14t/imrank"
outputimrankcr="../Results/freshRuns/algorithmOutput/fig14t/imrank"
mkdir -p ../Results/freshRuns/algorithmOutput/fig14t
