...
model="IC"
outputimm="../Results/freshRuns/algorithmOutput/fig12e/imm"
mkdir -p ../Results/freshRuns/algorithmOutput/fig12e
mkdir -p $outputimm
...
mkdir -p ../Results/freshRuns/processed/fig12e
python ../Codes/process12.py $outputimm"/flowstat_"$eps"_" ../Results/freshRuns/processed/fig12e/imm.txt
cp ../Results/Alreadypresent/fig12e/plotnew.p ../Results/freshRuns/processed/fig12e/
cd ../Results/freshRuns/processed/fig12e/
gnuplot plotnew.p
epspdf output.eps
