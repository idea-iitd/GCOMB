...
model="IC"
outputimrank="../../Results/freshRuns/algorithmOutput/fig15l/imrank"
outputimrankcr="../Results/freshRuns/algorithmOutput/fig15l/imrank"
mkdir -p ../Results/freshRuns/algorithmOutput/fig15l
...
cd ../Runningscript
mkdir -p ../Results/freshRuns/processed/fig15l
for l in 1 2
do
        python ../Codes/convergenceCheck.py imrank "../Results/freshRuns/algorithmOutput/fig15l/imrank/flowst_l="$l"_rounds=10.txt_300" "../Results/freshRuns/algorithmOutput/fig15l/imrank/flowst_l="$l"_rounds="  ../Results/freshRuns/processed/fig15l/$l".txt"
done
