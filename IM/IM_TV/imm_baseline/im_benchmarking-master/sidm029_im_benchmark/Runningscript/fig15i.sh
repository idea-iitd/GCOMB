...
model="LT"
outputeasyim="../Results/freshRuns/algorithmOutput/fig15i/easyim"
mkdir -p ../Results/freshRuns/algorithmOutput/fig15i
...
mkdir -p ../Results/freshRuns/processed/fig15i

python ../Codes/convergenceCheck.py easyim $outputeasyim"/flowstat_1000.txt_300" $outputcelf"/flowstat_"  ../Results/freshRuns/processed/fig15i/easyim.txt
