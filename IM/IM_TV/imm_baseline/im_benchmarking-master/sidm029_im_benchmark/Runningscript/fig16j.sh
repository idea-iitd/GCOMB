...
model="IC"
outputimm="../Results/freshRuns/algorithmOutput/fig16j/imm"
outputtim="../Results/freshRuns/algorithmOutput/fig16j/tim"
mkdir -p ../Results/freshRuns/algorithmOutput/fig16j
mkdir -p $outputimm
mkdir -p $outputtim
...
mkdir -p ../Results/freshRuns/processed/fig16j
python ../Codes/convergenceCheck.py imm ../Results/freshRuns/algorithmOutput/fig16j/imm/flowstat_0.05_300 ../Results/freshRuns/algorithmOutput/fig16j/imm/flowstat_ ../Results/freshRuns/processed/fig16j/imm.txt
echo "Running TIM+"
...
python ../Codes/convergenceCheck.py tim ../Results/freshRuns/algorithmOutput/fig16j/tim/flowstat_0.05_300 ../Results/freshRuns/algorithmOutput/fig16j/tim/flowstat_ ../Results/freshRuns/processed/fig16j/tim.txt
