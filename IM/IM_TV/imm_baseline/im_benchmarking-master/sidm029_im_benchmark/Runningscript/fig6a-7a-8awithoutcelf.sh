...
outputcelf="../Results/freshRuns/algorithmOutput/fig6a-7a-8a/celf"
outputcelfpp="../Results/freshRuns/algorithmOutput/fig6a-7a-8a/celfpp"
outputeasyim="../Results/freshRuns/algorithmOutput/fig6a-7a-8a/easyim"
outputimm="../Results/freshRuns/algorithmOutput/fig6a-7a-8a/imm"
outputtim="../Results/freshRuns/algorithmOutput/fig6a-7a-8a/tim"
outputpmc="../Results/freshRuns/algorithmOutput/fig6a-7a-8a/pmc"
outputimrank="../Results/freshRuns/algorithmOutput/fig6a-7a-8a/imrank"
outputsg="../Results/freshRuns/algorithmOutput/fig6a-7a-8a/sg"
outputirie="../Results/freshRuns/algorithmOutput/fig6a-7a-8a/irie"
#outputsimpath="../Results/freshRuns/algorithmOutput/fig6a-7a-8a/simpath"
#outputldag="../Results/freshRuns/algorithmOutput/fig6a-7a-8a/ldag"

mkdir -p ../Results/freshRuns/processed/fig6a-7a-8a
...
do
	...
	do
		...
		cat $outputimrank"/statIMRank_k"$seeds"_l"$l"_LOOP10_irDegree.txt" >> ../Results/freshRuns/processed/fig6a-7a-8a/imrank$l"time.txt" 
	...
	cp $outputimrank"/flowstat_l="$l"_rounds="$imrank_rounds".txt_300" ../Results/freshRuns/processed/fig6a-7a-8a/imrank$l".txt"
done
cd ../Runningscript
...
cp $outputpmc"/stats_PMC_IC_"$pmc_r".txt" ../Results/freshRuns/processed/fig6a-7a-8a/pmctime.txt
...
cp $outputpmc"/flowstat_"$pmc_r".txt_300" ../Results/freshRuns/processed/fig6a-7a-8a/pmc.txt
...
do
	...
	cat $outputsg"/statStaticGreedyUD_SGD_R"$sg_r"_k"$seeds".txt" >> ../Results/freshRuns/processed/fig6a-7a-8a/sgtime.txt
...
cp $outputsg"/flowstat_snapshots="$sg_r"_300"  ../Results/freshRuns/processed/fig6a-7a-8a/sg.txt
...
do
	...
	cat $outputimm"/stat_IMM_"$model"_"$seeds"_"$imm_eps".txt"  >> ../Results/freshRuns/processed/fig6a-7a-8a/immtime.txt
...
cp $outputimm"/flowstat_"$imm_eps"_300" ../Results/freshRuns/processed/fig6a-7a-8a/imm.txt
...
do
	...
	cat $outputtim"/stat_TIM_"$model"_"$seeds"_"$tim_eps".txt" >> ../Results/freshRuns/processed/fig6a-7a-8a/timtime.txt
...
cp $outputtim"/flowstat_"$tim_eps"_300" ../Results/freshRuns/processed/fig6a-7a-8a/tim.txt
...
do
	...
	cat $outputeasyim"/stat_seeds="$seeds"_iter="$easyim_iter"_depth=3.txt" >> ../Results/freshRuns/processed/fig6a-7a-8a/easyimtime.txt
...
cp $outputeasyim"/flowstat_"$easyim_iter".txt_300" ../Results/freshRuns/processed/fig6a-7a-8a/easyim.txt

paste ../Results/Alreadypresent/fig6abcd/seedfile ../Results/freshRuns/processed/fig6a-7a-8a/easyimtime.txt > tmp
mv tmp ../Results/freshRuns/processed/fig6a-7a-8a/easyimtime.txt

paste ../Results/Alreadypresent/fig6abcd/seedfile ../Results/freshRuns/processed/fig6a-7a-8a/immtime.txt > tmp
mv tmp ../Results/freshRuns/processed/fig6a-7a-8a/immtime.txt

paste ../Results/Alreadypresent/fig6abcd/seedfile ../Results/freshRuns/processed/fig6a-7a-8a/timtime.txt > tmp
mv tmp ../Results/freshRuns/processed/fig6a-7a-8a/timtime.txt

paste ../Results/Alreadypresent/fig6abcd/seedfile ../Results/freshRuns/processed/fig6a-7a-8a/imrank1time.txt > tmp
mv tmp ../Results/freshRuns/processed/fig6a-7a-8a/imrank1time.txt

paste ../Results/Alreadypresent/fig6abcd/seedfile ../Results/freshRuns/processed/fig6a-7a-8a/imrank2time.txt > tmp
mv tmp ../Results/freshRuns/processed/fig6a-7a-8a/imrank2time.txt

cp ../Results/Alreadypresent/fig6abcd/plotnew.p ../Results/freshRuns/processed/fig6a-7a-8a/
cp ../Results/Alreadypresent/fig6abcd/plotnewtime.p ../Results/freshRuns/processed/fig6a-7a-8a/
cp ../Results/Alreadypresent/fig6abcd/plotnewmem.p ../Results/freshRuns/processed/fig6a-7a-8a/
cd ../Results/freshRuns/processed/fig6a-7a-8a/
gnuplot plotnew.p
