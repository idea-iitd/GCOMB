...
model="IC"
outputpmc="../Results/freshRuns/algorithmOutput/fig16a/pmc"
outputsg="../../Results/freshRuns/algorithmOutput/fig16a/sg"
outputsgcr="../Results/freshRuns/algorithmOutput/fig16a/sg"
mkdir -p ../Results/freshRuns/algorithmOutput/fig16a
mkdir -p $outputpmc
mkdir -p $outputsgcr
numiter=10000
...
mkdir -p ../Results/freshRuns/processed/fig16a
python ../Codes/convergenceCheck.py pmc "../Results/freshRuns/algorithmOutput/fig16a/pmc/flowst_300.txt_300" "../Results/freshRuns/algorithmOutput/fig16a/pmc/flowst_"  ../Results/freshRuns/processed/fig16a/pmc.txt

pathtographsg="../../Dataset/nethept/graph_ic.inf"
...
cd ../Runningscript
python ../Codes/convergenceCheck.py static $outputsgcreate"/flowst_snapshots=300_300" "../Results/freshRuns/algorithmOutput/fig16a/sg/flowst_snapshots="  ../Results/freshRuns/processed/fig16a/sg.txt
