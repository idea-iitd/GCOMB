...
outputcelf="../Results/freshRuns/algorithmOutput/fig6i-7i-8i/celf"
outputcelfpp="../Results/freshRuns/algorithmOutput/fig6i-7i-8i/celfpp"
outputeasyim="../Results/freshRuns/algorithmOutput/fig6i-7i-8i/easyim"
outputimm="../Results/freshRuns/algorithmOutput/fig6i-7i-8i/imm"
outputtim="../Results/freshRuns/algorithmOutput/fig6i-7i-8i/tim"
outputpmc="../Results/freshRuns/algorithmOutput/fig6i-7i-8i/pmc"
outputimrank="../Results/freshRuns/algorithmOutput/fig6i-7i-8i/imrank"
outputsg="../Results/freshRuns/algorithmOutput/fig6i-7i-8i/sg"
outputirie="../Results/freshRuns/algorithmOutput/fig6i-7i-8i/irie"
outputsimpath="../Results/freshRuns/algorithmOutput/fig6i-7i-8i/simpath"
outputldag="../Results/freshRuns/algorithmOutput/fig6i-7i-8i/ldag"

mkdir -p ../Results/freshRuns/algorithmOutput/fig6i-7i-8i
mkdir -p ../Results/freshRuns/processed/fig6i-7i-8i
mkdir -p $outputcelf
...
do
	...
	cat $outputimm"/stat_IMM_"$model"_"$seeds"_"$imm_eps".txt"  >> ../Results/freshRuns/processed/fig6i-7i-8i/immtime.txt
...
cp $outputimm"/flowstat_"$imm_eps"_300" ../Results/freshRuns/processed/fig6i-7i-8i/imm.txt
...
do
	...
	cat $outputtim"/stat_TIM_"$model"_"$seeds"_"$tim_eps".txt" >> ../Results/freshRuns/processed/fig6i-7i-8i/timtime.txt
...
cp $outputtim"/flowstat_"$tim_eps"_300" ../Results/freshRuns/processed/fig6i-7i-8i/tim.txt
...
do
	...
	cat $outputeasyim"/stat_seeds="$seeds"_iter="$easyim_iter"_depth=3.txt" >> ../Results/freshRuns/processed/fig6i-7i-8i/easyimtime.txt
...
cp $outputeasyim"/flowstat_"$easyim_iter".txt_300" ../Results/freshRuns/processed/fig6i-7i-8i/easyim.txt
...
cp $outputsimpath"/stats_LTNew_"$simpath_mc".txt" ../Results/freshRuns/processed/fig6i-7i-8i/simpathtime.txt
...
cp $outputsimpath"/flowstat_"$simpath_mc".txt_300" ../Results/freshRuns/processed/fig6i-7i-8i/simpath.txt
...
cp $outputldag"/stats_LT.txt" ../Results/freshRuns/processed/fig6i-7i-8i/ldagtime.txt
...
cp $outputldag"/flowstat_"$ldag_mc".txt_300" ../Results/freshRuns/processed/fig6i-7i-8i/ldag.txt

paste ../Results/Alreadypresent/fig6abcd/seedfile ../Results/freshRuns/processed/fig6i-7i-8i/easyimtime.txt > tmp
mv tmp ../Results/freshRuns/processed/fig6i-7i-8i/easyimtime.txt

paste ../Results/Alreadypresent/fig6abcd/seedfile ../Results/freshRuns/processed/fig6i-7i-8i/immtime.txt > tmp
mv tmp ../Results/freshRuns/processed/fig6i-7i-8i/immtime.txt

paste ../Results/Alreadypresent/fig6abcd/seedfile ../Results/freshRuns/processed/fig6i-7i-8i/timtime.txt > tmp
mv tmp ../Results/freshRuns/processed/fig6i-7i-8i/timtime.txt


cp ../Results/Alreadypresent/fig6ijkl/plotnew.p ../Results/freshRuns/processed/fig6i-7i-8i/
cp ../Results/Alreadypresent/fig6ijkl/plotnewtime.p ../Results/freshRuns/processed/fig6i-7i-8i/
cp ../Results/Alreadypresent/fig6ijkl/plotnewmem.p ../Results/freshRuns/processed/fig6i-7i-8i/
cd ../Results/freshRuns/processed/fig6i-7i-8i/
gnuplot plotnew.p
