...
model="IC"
outputimm="../Results/freshRuns/algorithmOutput/fig12a/imm"
mkdir -p ../Results/freshRuns/algorithmOutput/fig12a
mkdir -p $outputimm
...
mkdir -p ../Results/freshRuns/processed/fig12a
python ../Codes/process12.py $outputimm"/flowstat_"$eps"_" ../Results/freshRuns/processed/fig12a/imm.txt
cp ../Results/Alreadypresent/fig12a/plotnew.p ../Results/freshRuns/processed/fig12a/
cd ../Results/freshRuns/processed/fig12a/
gnuplot plotnew.p
epspdf output.eps
