...
model="IC"
outputimrank="../../Results/freshRuns/algorithmOutput/fig15n/imrank"
outputimrankcr="../Results/freshRuns/algorithmOutput/fig15n/imrank"
mkdir -p ../Results/freshRuns/algorithmOutput/fig15n
...
cd ../Runningscript
mkdir -p ../Results/freshRuns/processed/fig15n
for l in 1 2
do
        python ../Codes/convergenceCheck.py imrank "../Results/freshRuns/algorithmOutput/fig15n/imrank/flowst_l="$l"_rounds=10.txt_300" "../Results/freshRuns/algorithmOutput/fig15n/imrank/flowst_l="$l"_rounds="  ../Results/freshRuns/processed/fig15n/$l".txt"
done
