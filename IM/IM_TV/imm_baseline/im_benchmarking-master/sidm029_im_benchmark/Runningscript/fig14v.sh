...
model="IC"
outputimrank="../../Results/freshRuns/algorithmOutput/fig14v/imrank"
outputimrankcr="../Results/freshRuns/algorithmOutput/fig14v/imrank"
mkdir -p ../Results/freshRuns/algorithmOutput/fig14v
