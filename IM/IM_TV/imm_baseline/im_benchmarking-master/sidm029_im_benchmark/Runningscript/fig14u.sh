...
model="WC"
outputimrank="../../Results/freshRuns/algorithmOutput/fig14u/imrank"
outputimrankcr="../Results/freshRuns/algorithmOutput/fig14u/imrank"
mkdir -p ../Results/freshRuns/algorithmOutput/fig14u
