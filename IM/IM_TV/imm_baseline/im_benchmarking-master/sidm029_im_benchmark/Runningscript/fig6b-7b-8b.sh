...
cp $outputcelf"/stats_CELF_IC_"$celf_mc".txt" ../Results/freshRuns/processed/fig6b-7b-8b/celftime.txt
...
cp $outputcelf"/flowstat_"$celf_mc".txt_300" ../Results/freshRuns/processed/fig6b-7b-8b/celf.txt
...
cp $outputcelfpp"/stats_CELF++_IC_"$celfpp_mc".txt" ../Results/freshRuns/processed/fig6b-7b-8b/celfpptime.txt
...
cp $outputcelfpp"/flowstat_"$celfpp_mc".txt_300" ../Results/freshRuns/processed/fig6b-7b-8b/celfpp.txt
