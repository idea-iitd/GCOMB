...
outputcelf="../Results/freshRuns/algorithmOutput/fig6g-7g-8g/celf"
outputcelfpp="../Results/freshRuns/algorithmOutput/fig6g-7g-8g/celfpp"
outputeasyim="../Results/freshRuns/algorithmOutput/fig6g-7g-8g/easyim"
outputimm="../Results/freshRuns/algorithmOutput/fig6g-7g-8g/imm"
outputtim="../Results/freshRuns/algorithmOutput/fig6g-7g-8g/tim"
outputpmc="../Results/freshRuns/algorithmOutput/fig6g-7g-8g/pmc"
outputimrank="../Results/freshRuns/algorithmOutput/fig6g-7g-8g/imrank"
outputsg="../Results/freshRuns/algorithmOutput/fig6g-7g-8g/sg"
outputirie="../Results/freshRuns/algorithmOutput/fig6g-7g-8g/irie"
#outputsimpath="../Results/freshRuns/algorithmOutput/fig6g-7g-8g/simpath"
#outputldag="../Results/freshRuns/algorithmOutput/fig6g-7g-8g/ldag"
mkdir -p ../Results/freshRuns/processed/fig6g-7g-8g
mkdir -p ../Results/freshRuns/algorithmOutput/fig6g-7g-8g
mkdir -p $outputcelf
...
do
	...
	do
		...
		cat $outputimrank"/statIMRank_k"$seeds"_l"$l"_LOOP10_irDegree.txt" >> ../Results/freshRuns/processed/fig6g-7g-8g/imrank$l"time.txt"
	...
	cp $outputimrank"/flowstat_l="$l"_rounds="$imrank_rounds".txt_300" ../Results/freshRuns/processed/fig6g-7g-8g/imrank$l".txt"
done
cd ../Runningscript
...
do
	...
	cat $outputirie"/statFileseeds-"$seeds".txt" >> ../Results/freshRuns/processed/fig6g-7g-8g/irietime.txt
...
cp $outputirie"/flowstat_alpha=0.7_300" ../Results/freshRuns/processed/fig6g-7g-8g/irie.txt
...
cp $outputpmc"/stats_PMC_IC_"$pmc_r".txt" ../Results/freshRuns/processed/fig6g-7g-8g/pmctime.txt
...
cp $outputpmc"/flowstat_"$pmc_r".txt_300" ../Results/freshRuns/processed/fig6g-7g-8g/pmc.txt
...
do
	...
	cat $outputsg"/statStaticGreedyUD_SGD_R"$sg_r"_k"$seeds".txt" >> ../Results/freshRuns/processed/fig6g-7g-8g/sgtime.txt
...
cp $outputsg"/flowstat_snapshots="$sg_r"_300"  ../Results/freshRuns/processed/fig6g-7g-8g/sg.txt
cd ../Runningscript
...
do
	...
	cat $outputimm"/stat_IMM_"$model"_"$seeds"_"$imm_eps".txt"  >> ../Results/freshRuns/processed/fig6g-7g-8g/immtime.txt
...
cp $outputimm"/flowstat_"$imm_eps"_300" ../Results/freshRuns/processed/fig6g-7g-8g/imm.txt
echo "Running TIM+"
for seeds in 1 2 5 10 25 50 75 100 125 150 175 200
do
	...
	cat $outputtim"/stat_TIM_"$model"_"$seeds"_"$tim_eps".txt" >> ../Results/freshRuns/processed/fig6g-7g-8g/timtime.txt
...
cp $outputtim"/flowstat_"$tim_eps"_300" ../Results/freshRuns/processed/fig6g-7g-8g/tim.txt
echo "Running EaSyIM"
for seeds in 1 2 5 10 25 50 75 100 125 150 175 200
do
	...
	cat $outputeasyim"/stat_seeds="$seeds"_iter="$easyim_iter"_depth=3.txt" >> ../Results/freshRuns/processed/fig6g-7g-8g/easyimtime.txt
...
cp $outputeasyim"/flowstat_"$easyim_iter".txt_300" ../Results/freshRuns/processed/fig6g-7g-8g/easyim.txt
...
cp $outputcelf"/stats_CELF_IC_"$celf_mc".txt" ../Results/freshRuns/processed/fig6g-7g-8g/celftime.txt
...
cp $outputcelf"/flowstat_"$celf_mc".txt_300" ../Results/freshRuns/processed/fig6g-7g-8g/celf.txt
echo "Running CELF++"
...
cp $outputcelfpp"/stats_CELF++_IC_"$celfpp_mc".txt" ../Results/freshRuns/processed/fig6g-7g-8g/celfpptime.txt
...
cp $outputcelfpp"/flowstat_"$celfpp_mc".txt_300" ../Results/freshRuns/processed/fig6g-7g-8g/celfpp.txt
