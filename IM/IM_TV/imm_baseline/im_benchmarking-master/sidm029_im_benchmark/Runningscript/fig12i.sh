...
model="LT"
outputimm="../Results/freshRuns/algorithmOutput/fig12i/imm"
mkdir -p ../Results/freshRuns/algorithmOutput/fig12i
mkdir -p $outputimm
...
mkdir -p ../Results/freshRuns/processed/fig12i
python ../Codes/process12.py $outputimm"/flowstat_"$eps"_" ../Results/freshRuns/processed/fig12i/imm.txt
