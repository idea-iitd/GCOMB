...
edge=2099732
node=317080
outputimrank="../../Results/freshRuns/algorithmOutput/fig15m/imrank"
outputimrankcr="../Results/freshRuns/algorithmOutput/fig15m/imrank"
mkdir -p ../Results/freshRuns/algorithmOutput/fig15m
...
cd ../Runningscript
mkdir -p ../Results/freshRuns/processed/fig15m
for l in 1 2
do
        python ../Codes/convergenceCheck.py imrank "../Results/freshRuns/algorithmOutput/fig15m/imrank/flowst_l="$l"_rounds=10.txt_300" "../Results/freshRuns/algorithmOutput/fig15m/imrank/flowst_l="$l"_rounds="  ../Results/freshRuns/processed/fig15m/$l".txt"
done
