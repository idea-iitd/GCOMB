...
model="IC"
outputimm="../Results/freshRuns/algorithmOutput/fig12k/imm"
mkdir -p ../Results/freshRuns/algorithmOutput/fig12k
mkdir -p $outputimm
...
mkdir -p ../Results/freshRuns/processed/fig12k
python ../Codes/process12.py $outputimm"/flowstat_"$eps"_" ../Results/freshRuns/processed/fig12k/imm.txt
