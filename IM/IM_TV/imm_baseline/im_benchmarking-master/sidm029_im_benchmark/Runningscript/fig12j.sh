...
model="IC"
outputimm="../Results/freshRuns/algorithmOutput/fig12j/imm"
mkdir -p ../Results/freshRuns/algorithmOutput/fig12j
mkdir -p $outputimm
...
mkdir -p ../Results/freshRuns/processed/fig12j
python ../Codes/process12.py $outputimm"/flowstat_"$eps"_" ../Results/freshRuns/processed/fig12j/imm.txt
