...
model="IC"
outputpmc="../Results/freshRuns/algorithmOutput/fig16f/pmc"
outputsg="../../Results/freshRuns/algorithmOutput/fig16f/sg"
outputsgcr="../Results/freshRuns/algorithmOutput/fig16f/sg"
mkdir -p ../Results/freshRuns/algorithmOutput/fig16f
mkdir -p $outputpmc
mkdir -p $outputsgcr
numiter=10000
...
mkdir -p ../Results/freshRuns/processed/fig16f
python ../Codes/convergenceCheck.py pmc "../Results/freshRuns/algorithmOutput/fig16f/pmc/flowst_300.txt_300" "../Results/freshRuns/algorithmOutput/fig16f/pmc/flowst_"  ../Results/freshRuns/processed/fig16f/pmc.txt
...
cd ../Runningscript
python ../Codes/convergenceCheck.py static $outputsgcreate"/flowst_snapshots=300_300" "../Results/freshRuns/algorithmOutput/fig16f/sg/flowst_snapshots="  ../Results/freshRuns/processed/fig16f/sg.txt
