...
do
	...
	cat $outputeasyim"/stat_seeds="$seeds"_iter="$easyim_iter"_depth=3.txt" >> ../Results/freshRuns/processed/fig6l-7l-8l/easyimtime.txt
...
cp $outputeasyim"/flowstat_"$easyim_iter".txt_300" ../Results/freshRuns/processed/fig6l-7l-8l/easyim.txt
...
cp $outputcelf"/stats_LDAG_LT_"$ldag_mc".txt" ../Results/freshRuns/processed/fig6l-7l-8l/ldagtime.txt
...
cp $outputcelf"/flowstat_"$ldag_mc".txt_300" ../Results/freshRuns/processed/fig6l-7l-8l/ldag.txt
...
cp $outputcelf"/stats_CELF_LT_"$celf_mc".txt" ../Results/freshRuns/processed/fig6l-7l-8l/celftime.txt
...
cp $outputcelf"/flowstat_"$celf_mc".txt_300" ../Results/freshRuns/processed/fig6l-7l-8l/celf.txt
...
cp $outputcelfpp"/stats_CELF++_LT_"$celfpp_mc".txt" ../Results/freshRuns/processed/fig6l-7l-8l/celfpptime.txt
...
cp $outputcelfpp"/flowstat_"$celfpp_mc".txt_300" ../Results/freshRuns/processed/fig6l-7l-8l/celfpp.txt
