...
vector<double> processSpread(vector<double> &spreadVec, int BinSize){
    ...
    vector<double> meanSpread;
     int numBins=spreadVec.size()/100;
    //int numBins=100;
...
int main(int argc,char *argv[]){
    ...
    vector<int> binSize;
    //binSize.push_back(100);binSize.push_back(200);binSize.push_back(300),binSize.push_back(400);
	...
	spreadOpFile.open(spreadFileName+"_"+to_string((long long int)num_seeds),ios::out | ios_base::app);
        for(int i=0;i<num_iter;i++){
          ...
          clock_t start = clock();
          running_spread=lt_flow_efficient(g,seeds,lambda);
          clock_t end = clock();
