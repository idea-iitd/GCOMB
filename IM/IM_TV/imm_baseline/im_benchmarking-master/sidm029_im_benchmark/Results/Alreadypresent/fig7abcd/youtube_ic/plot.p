...
set xtics 0,25,200
set logscale y
plot    'youtube_ic_200_time.txt' using 1:2 title 'PMC' lw 5 ps 2.3 lt 1 lc 5 with linespoint, \
	 'youtube_ic_1000_EASY' using 1:($2*1000) title 'EaSyIM' lw 5 ps 2.3 lt 1 lc 6 with linespoint