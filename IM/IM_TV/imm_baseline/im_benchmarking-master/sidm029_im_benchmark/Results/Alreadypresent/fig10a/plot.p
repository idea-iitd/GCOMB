...
plot 'nethept_weilu_ldag_output.txt_time.txt' using 1:2 title 'LDAG' lw 7.5 ps 4.5 pt 6 lt 1 lc 1 with linespoint, \
    'nethept_weilu_output.txt_time_simpath.txt' using 1:2 title 'SIMPATH' lw 7.5 ps 4.5 pt 10 lt 1 lc 2 with linespoint