...
plot 'celf_hepph_ic' using 1:2 title 'CELF' lw 7.5 ps 4.5 pt 14 lt 1 lc 1 with linespoint, \
    'celf++_hepph_ic' using 1:2 title 'CELF++' lw 7.5 ps 4.5 pt 4 lt 1 lc 2 with linespoint, \
     'hepph_easyim_ic' using 1:2 title 'EaSyIM' lw 7.5 ps 4.5 pt 6 lt 1 lc 3 with linespoint