...
plot 'nethept_imm_lt' using 1:2 title 'IMM' lw 6.5 ps 3.5 pt 14 lt 1 lc 1 with linespoint, \
     'tim_nethept_lt' using 1:2 title 'TIM^+' lw 6.5 ps 3.5 pt 4 lt 1 lc 2 with linespoint