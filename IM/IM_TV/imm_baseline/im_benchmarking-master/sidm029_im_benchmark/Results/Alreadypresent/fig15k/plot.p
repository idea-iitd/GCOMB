...
plot 'imrank_nethept_wc' using 1:2 title 'l=1' lw 7.5 ps 4.5 pt 14 lt 1 lc 1 with linespoint, \
     'imrank2_nethept_wc' using 1:2 title 'l=2' lw 7.5 ps 4.5 pt 4 lt 1 lc 2 with linespoint