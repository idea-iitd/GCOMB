...
plot 'hepph_imm_lt' using 1:2 title 'IMM' lw 7.5 ps 4.5 pt 14 lt 1 lc 1 with linespoint, \
     'tim_hepph_lt' using 1:2 title 'TIM^+' lw 7.5 ps 4.5 pt 4 lt 1 lc 2 with linespoint