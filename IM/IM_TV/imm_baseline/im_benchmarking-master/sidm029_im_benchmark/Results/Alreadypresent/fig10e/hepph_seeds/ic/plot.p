...
set xtics 0,0.2,1
plot 'hepph_IC_other200' using 1:2   title 'TIM' lw 6.5 ps 3.5 pt 6 lt 1 lc 1 with linespoint, \
'stat_TIM_hepph_IC_other200' using 1:2 title 'Framework ({ /Symbol s})' lw 6.5 ps 3.5 pt 10 lt 1 lc 2 with linespoint