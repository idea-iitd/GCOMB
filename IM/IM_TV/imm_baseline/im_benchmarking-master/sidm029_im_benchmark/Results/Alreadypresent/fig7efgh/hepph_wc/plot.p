...
plot 'celf_200_10000_52.txt_time.txt' using 1:($2*60) title 'CELF' lw 5 ps 2.3 pt 14 lt 1 lc 1 with linespoint, \
     'celf++_200_10000_46.txt_time.txt' using 1:($2*60) title 'CELF++' lw 5 ps 2.3 lt 1 lc 2 with linespoint, \
     'hepph_WC_0.15_time.txt' using 1:2 title 'TIM' lw 5 ps 2.3 lt 1 lc 3 with linespoint, \
     'hepph_WC_0.1_time_imm.txt' using 1:2 title 'IMM' lw 5 ps 2.3 lt 1 lc 4 with linespoint, \
     'hepph_ic_200_time.txt' using 1:2 title 'PMC' lw 5 ps 2.3 lt 1 lc 5 with linespoint, \
	 'hepph_wc_250_EASY' using 1:($2*250) title 'EaSyIM' lw 5 ps 2.3 lt 1 lc 6 with linespoint