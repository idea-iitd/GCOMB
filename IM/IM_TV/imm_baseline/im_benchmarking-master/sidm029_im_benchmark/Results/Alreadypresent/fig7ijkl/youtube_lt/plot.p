...
set xtics 0,25,200
set logscale y
plot 'youtube_LT_0.35_time.txt' using 1:2 title 'TIM' lw 5 ps 2.3 lt 1 lc 3 with linespoint, \
     'youtube_LT_0.1_time_time_imm.txt' using 1:2 title 'IMM' lw 5 ps 2.3 lt 1 lc 4 with linespoint, \
	 'youtube_lt_75_EASY' using 1:($2*75) title 'EaSyIM' lw 5 ps 2.3 lt 1 lc 6 with linespoint