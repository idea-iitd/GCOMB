...
plot 'pmc_youtube_ic' using 1:2 title 'PMC' lw 6.5 ps 3.5 pt 14 lt 1 lc 1 with linespoint,\
	'sg_youtube_ic' using 1:2 title 'Static Greedy' lw 6.5 ps 3.5 pt 4 lt 1 lc 2 with linespoint