...
plot 'celf_nethept_wc' using 1:2 title 'CELF' lw 6.5 ps 3.5 pt 14 lt 1 lc 1 with linespoint, \
     'celf++_nethept_wc' using 1:2 title 'CELF++' lw 6.5 ps 3.5 pt 4 lt 1 lc 2 with linespoint, \
     'nethept_easyim_wc' using 1:2 title 'EaSyIM' lw 6.5 ps 3.5 pt 6 lt 1 lc 3 with linespoint