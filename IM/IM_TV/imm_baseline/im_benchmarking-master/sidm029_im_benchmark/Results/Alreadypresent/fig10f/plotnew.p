...
plot 'wrong.txt' using 1:2  title 'Incorrect' lw 6.5 ps 3.5 pt 6 lt 1 lc 1 with linespoint, \
'correct.txt' using 1:2 title 'Corrected' lw 6.5 ps 3.5 pt 10 lt 1 lc 2 with linespoint
