...
plot 'celf_200_10000_52.txt_memory.txt' using 1:2 title 'CELF' lw 5 ps 2.3 pt 14 lt 1 lc 1 with linespoint, \
     'celf++_200_10000_51.txt_memory.txt' using 1:2 title 'CELF++' lw 5 ps 2.3 lt 1 lc 2 with linespoint, \
     'hepph_LT_0.35_memory_tim.txt' using 1:2 title 'TIM' lw 5 ps 2.3 lt 1 lc 3 with linespoint, \
     'hepph_LT_0.1_memory_imm.txt' using 1:2 title 'IMM' lw 5 ps 2.3 lt 1 lc 4 with linespoint, \
	 'hepph_lt_memory' using 1:2 title 'EaSyIM' lw 5 ps 2.3 lt 1 lc 6 with linespoint