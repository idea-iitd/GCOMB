...
plot 'dblp_LT_0.35_memory_tim.txt' using 1:2 title 'TIM' lw 5 ps 2.3 lt 1 lc 3 with linespoint, \
     'dblp_LT_0.1_memory_imm.txt' using 1:2 title 'IMM' lw 5 ps 2.3 lt 1 lc 4 with linespoint, \
	 'dblp_lt_memory' using 1:2 title 'EaSyIM' lw 5 ps 2.3 lt 1 lc 6 with linespoint