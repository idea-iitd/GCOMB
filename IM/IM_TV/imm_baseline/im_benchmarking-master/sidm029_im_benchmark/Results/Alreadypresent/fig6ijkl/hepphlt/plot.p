...
plot 'stat_200_celf_10000.txt' using 1:2 title 'CELF' lw 5 ps 2.3 pt 14 lt 1 lc 1 with linespoint, \
     ...
     'stat_IMM_hepph_LT_0.1.txt' using 1:2 title 'IMM' lw 5 ps 2.3 lt 1 lc 3 with linespoint, \
     'stat_TIM_hepph_LT_0.1.txt' using 1:2 title 'TIM' lw 5 ps 2.3 lt 1 lc 4 with linespoint, \
     'stat_st_hepph_lt_75.txt' using 1:2 title 'EaSyIM' lw 5 ps 2.3 lt 1 lc 4 with linespoint