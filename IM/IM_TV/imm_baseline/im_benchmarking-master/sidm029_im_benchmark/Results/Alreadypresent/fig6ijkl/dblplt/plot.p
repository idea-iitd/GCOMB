...
plot 'stat_IMM_dblp_LT_0.1.txt' using 1:2 title 'IMM' lw 5 ps 2.3 lt 1 lc 3 with linespoint,\
    'stat_TIM_dblp_LT_0.35.txt' using 1:2 title 'TIM' lw 5 ps 2.3 lt 1 lc 5 with linespoint, \
    'stat_st_dblp_lt_75.txt' using 1:2 title 'EaSyIM' lw 5 ps 2.3 lt 1 lc 5 with linespoint