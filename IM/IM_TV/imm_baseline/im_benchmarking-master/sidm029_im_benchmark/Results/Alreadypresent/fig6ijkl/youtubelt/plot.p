...
plot 'stat_IMM_youtube_LT_0.1.txt' using 1:2 title 'IMM' lw 5 ps 2.3 lt 1 lc 3 with linespoint, \
     'stat_TIM_youtube_LT_0.35.txt' using 1:2 title 'TIM' lw 5 ps 2.3 lt 1 lc 4 with linespoint, \
     'stat_st_youtube_lt_75.txt' using 1:2 title 'EaSyIM' lw 5 ps 2.3 lt 1 lc 4 with linespoint