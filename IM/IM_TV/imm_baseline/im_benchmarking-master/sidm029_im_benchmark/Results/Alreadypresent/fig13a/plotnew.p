...
set style histogram clustered gap 1.5 title textcolor lt -1
...
#set title "Node lookup Comparison"
...
set ylabel "Avergae \#Node Lookups" 
set xlabel "Independent Runs (WC)" 

set yrange [0 : 22 ] noreverse nowriteback
set ytics 0,4,20

plot 'lookup.txt' using ($2):xtic(1) ti col lw 4 lc 1 lt 1, '' u ($3) ti col lw 4 lc 2 lt 1
