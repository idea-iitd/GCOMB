...
plot 'imm.txt' using 1:($2):3 title 'NetHept (IC)' lw 7.5 ps 4.5 pt 14 lt 1 lc 1  with yerrorbars, \
'imm.txt' using 1:($2) title '' lw 7.5 ps 4.5 pt 14 lt 1 lc 1  with linespoint
