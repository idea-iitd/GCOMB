		...
		for sampling_freq in[0.003]:# [0.0005,0.001,0.003, 0.005,0.007,0.010,0.05,0.1]:
			...
			for budget in [10,20,50,100,150,200]:
				try:
					print(sampling_freq)
					print(budget)
					graph_rl_file = graph_path+"_sup_GS_sol.txt_{}_nbs_{}".format(budget, sampling_freq)
					...
					print('Spread = ', spread)
					reward_file_name = graph_path+"_SUP_GS_REWARD_budget_"+str(budget)+"_nbs_"+str(sampling_freq)
